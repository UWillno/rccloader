var rccLoader_entry = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    async function findWasmBinary() {
      // return locateFile("rccLoader.wasm");
      return await loadAndMergeWasm(wasmParts);
    }
    ...
    var ASM_CONSTS = {
      ...
      10433217: ($0) => {
        ...
        let handler = (arg) => {
          control.pendingEvents.push({ index, arg });
          if (control.resume) {
...
if (typeof exports === "object" && typeof module === "object") {
  module.exports = rccLoader_entry;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = rccLoader_entry;
} else if (typeof define === "function" && define["amd"])
  define([], () => rccLoader_entry);
